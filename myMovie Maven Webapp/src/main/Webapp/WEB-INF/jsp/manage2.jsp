            ...
            <div class="show-top-grids-w3lagile">
                <div class="col-sm-8 single-left">
                    <div class="song-grid-right">
                        <div class="share">
                            <form action="${pageContext.request.contextPath}/UserControl/manage2.do" method="post">
                              <div class="table-b">
                                    <table class="zk"  width="800" border="1px" cellspacing="0" cellpadding="0" style="text-align: center;line-height: 40px">
                                        ...
                                        <tr>
                                            <td>新用户名</td>                                           
                                            <td><input type="text" name="user_Name" maxlength="12" minlength="1" style="line-height: 30px" placeholder="新用户名"></td>
                                        </tr>
                                        <tr>
                                            <td>新邮箱号码</td>                                            
                                            <td><input type="email" name="user_Email" style="line-height: 30px" placeholder="新邮箱号码"></td>
                                        </tr>
                                        <tr>
                                            <td>新电话号码</td>
                                            <td><input type="tel" name="user_Tel" style="line-height: 30px" placeholder="新电话号码"></td>
                                        </tr>
                                        <tr>
                                            <td>新QQ</td>
                                            <td><input type="text" name="user_QQ" style="line-height: 30px" placeholder="新QQ"></td>
                                        </tr>
                                    </table>
                                  <br>
                                    <div style="padding-left: 50%"><input type="submit" style="text-align: center;line-height: 20px" value="提交更改"></div>
                            </div>
                            </form>
                        </div>
                    </div>
