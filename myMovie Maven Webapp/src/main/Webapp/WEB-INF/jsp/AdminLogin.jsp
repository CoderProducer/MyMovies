            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav>
                     <ul class="nav navbar-nav">
                        <li class="active"><a href="${pageContext.request.contextPath}/PageVisitControl/index.do">首页</a></li>
        ...
        <div class="w3_agile_banner_bottom_grid">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            My Movies 管理员登录
                            <span class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><a href="index.html"><span style="color: black;font-size: small">返回首页</span></a></span></span>
                            ...
                            <div class="modal-body">
                                <div class="w3_login_module">
                                    <div class="module form-module">
                                        ...
                                        <div class="form">
                                            <span style="text-align: center;padding-left: 40%">管理员</span>
                                            <form action="${pageContext.request.contextPath}/AdminControl/AdminLogin.do" method="post">
                                                <input type="text" name="AdminName" placeholder="管理员名字">
                                                <input type="password" name="AdminPassword" placeholder="管理员密码"><br>
