...
<form action="#" method="post" class="definewidth m20" enctype="multipart/form-data">
    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
        <tr>
            <td width="10%" class="tableleft">电视剧类别</td>
            <td>
                <select name="tvBigTypeId">
        ...
        <tr>
            ...
            <td>
                <select name="tvSmallTypeId">
                    <option value="0">大陆剧</option>
                    <option value='1'>&nbsp;欧美剧</option>
                    <option value='1'>&nbsp;港台剧</option>
                    <option value='7'>&nbsp;日韩剧</option>
        ...
        <tr>
            ...
            <td><input type="text" name="videosSize" placeholder="以M为单位"/>&nbsp;&nbsp;M</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="tableleft">电视集数</td>
            <td>第&nbsp;<input style="width: 20%" type="text" name="videosNumber" placeholder="1、2..."/>&nbsp;集</td>
        </tr>
        <tr>
