...
<form action="#" method="post" class="definewidth m20" enctype="multipart/form-data">
    <table class="table table-bordered table-hover m10" style="margin-left:10px;margin-top:3px;">
        ...
        <tr>
            ...
            <td>
                <select name="varietySmallTypeId">
                    <option value="0">中国大陆</option>
                    <option value='1'>&nbsp;韩国</option>
                    <option value='1'>&nbsp;日本</option>
                    <option value='7'>&nbsp;港台</option>
        ...
        <tr>
            <td class="tableleft">视频(集/期)数</td>
            <td>第&nbsp;<input style="width: 20%" type="text" name="videosNumber" placeholder="1、2..."/>&nbsp;集/期</td>
        </tr>
        <tr>
