            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/VideoControl/comic.do">动漫</a></li>
            ...
            <div class="browse-agile-w3ls general-w3ls">
                ...
                <div class="container">
                    ...
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                        <form name="form1" action="${pageContext.request.contextPath}/VideoControl/comic.do" method="post">
                            <div>
                             	<input type="hidden" name="pageIndex" value="1"/>
                    ...
                    <div class="w3ls-news-result">
                        <h4>搜索 结果 : <span>${totalCount }条</span></h4>
                           ...
                           <ul class="main-member">
								<c:forEach var="message" items="${comicList}">
