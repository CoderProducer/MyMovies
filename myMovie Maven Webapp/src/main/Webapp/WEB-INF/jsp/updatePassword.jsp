...
<div class="single-page-agile-main">
    ...
    <div class="container">
            ...
            <div class="clearfix"></div>
            <form action="${pageContext.request.contextPath}/UserControl/updatePassword.do" method="post">
            <ul class="info_box">
                <li>旧密码:&nbsp;&nbsp;&nbsp;<input type="password" name="oldPassword" required="required"></li>
                <li>新密码:&nbsp;&nbsp;&nbsp;<input type="password" name="newPassword" minlength="6" maxlength="12" placeholder="长度6~12位" required="required"></li>
                <li>确认密码:&nbsp;&nbsp;<input type="password" name="checkPassword" minlength="6" maxlength="12" placeholder="长度6~12位" required="required"></li>
                <li style="padding-left: 20%"><input type="submit" STYLE="text-align: center;background: grey;color: black;" name="提交" value="提交"></li>
            </ul>
            </form>
        </div>
</div>
