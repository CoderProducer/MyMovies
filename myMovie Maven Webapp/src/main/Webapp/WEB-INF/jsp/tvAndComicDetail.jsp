                ...
                <div class="col-sm-8 single-left">
                    ...
                    <div class="song-grid-right">
                        <div class="share">
                            ...
                            <div>
                                <ul>
                                    <li><span>演员：</span>胡歌&nbsp;&nbsp;杨幂&nbsp;&nbsp;刘诗诗&nbsp;&nbsp;霍建华&nbsp;&nbsp;</li>
                                ...
                                <div>
                                    <ul>
                                        <li style="float: left;"><h5 style="width: 30px;height: 30px;line-height: 25px;border:solid pink 1px;margin: 5px 5px;"><a href="http://www.iqiyi.com/v_19rrg5ox8g.html" target="_blank" style="margin: 5px 5px;padding: 2px 2px;width: 30px;height: 15px;text-align: center;">11</a></h5></li>
                                        <li style="float: left;"></li>
                                        <li style="float: left;"><h5 style="width: 30px;height: 30px;line-height: 25px;border:solid pink 1px;margin: 5px 5px;"><a href="http://www.iqiyi.com/v_19rrg5ox8g.html" target="_blank" style="margin: 5px 5px;padding: 2px 2px;width: 30px;height: 15px;text-align: center;">12</a></h5></li>
                                        <li style="float: left;"></li>
                                        <li style="float: left;"><h5 style="width: 30px;height: 30px;line-height: 25px;border:solid pink 1px;margin: 5px 5px;"><a href="http://www.iqiyi.com/v_19rrg5ox8g.html" target="_blank" style="margin: 5px 5px;padding: 2px 2px;width: 30px;height: 15px;text-align: center;">13</a></h5></li>
                                        <li style="float: left;"></li>
                                        <li style="float: left;"><h5 style="width: 30px;height: 30px;line-height: 25px;border:solid pink 1px;margin: 5px 5px;"><a href="http://www.iqiyi.com/v_19rrg5ox8g.html" target="_blank" style="margin: 5px 5px;padding: 2px 2px;width: 30px;height: 15px;text-align: center;">14</a></h5></li>
                                        <li style="float: left;"></li>
                                        <nobr style="width: 2px;height: 2px"></nobr>
                    ...
                    <div>
                        <ul style="list-style: none">
                            ...
                            <li><input type="checkbox" name="items" value="蓝球" /><a href="http://xunleib.zuida360.com/1812/X辰变-11.mp4" download="文件名">点击下载</a></li>
                            <li><input type="checkbox" name="items" value="蓝球" /><a href="http://vip.zuiku8.com/1812/X辰变-12.mp4" download="文件名">点击下载</a></li>
                            <li><input type="checkbox" name="items" value="蓝球" /><a href="http://xunlei.zuidaxunlei.com/1812/YWW传：张天志.TC清晰版.mp4" download="文件名">点击下载</a></li>
